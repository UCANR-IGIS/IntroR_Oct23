...
## function or operator of your choice.
...
## Q7. Write an expression that returns a vector containing the 
## FIRST 10 UPPERCASE letters of the alphabet.


## Q8. Write an expression that returns a vector containing the 
## LAST 5 LOWERCASE letter of the alphabet.

## Q9. Write an expression that returns a vector containing the EVEN numbers 
## from 1 to 20 (i.e., 2, 4, 6, 8, ..., 20).


## Q10. Write an expression that returns a vector containing the ODD numbers 
## from 1 to 20 (i.e., 1, 3, 5, 7, ..., 19).
